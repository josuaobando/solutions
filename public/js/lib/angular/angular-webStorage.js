 ...
 * by calling `webStorage.order(['angular-webstorage', 'local', 'memory'])` and the
...
webStorageModule.factory('webStorage', ['$rootScope', 'defaultSettings', function ($rootScope, defaultSettings) {
	...
	/**
	 * Boolean flag indicating client support for angular-webstorage storage.
	 * @private
	 */
	...
	var webStorage = {
		...
		/**
		 * The angular-webstorage storage API.
		 * The API is the same as the generic API for the webStore service, but will
		 * only operate directly on the angular-webstorage store. Errors will be broadcast via
		 * the $rootScope.
		 */
		session: {
	 ...
	 *
	 * NOTE: This method will use local or angular-webstorage storage depending on the
	 ...
	 *
	 * NOTE: The method will use local or angular-webstorage storage depending on the
	 * client's support as well as the order set in the module constant 'order'.
	 ...
	 *   to query storage engines. Recognized names are 'local', 'angular-webstorage'
	...
	/**
	 * Add the specified key/value pair to the angular-webstorage web store.
	 *
	 * NOTE: The web store API only specifies that implementations should be able to
	 * handle string values, this method will therefore stringify all values into
	 * JSON strings before storing them.
	...
	/**
	 * Get the specified value from the angular-webstorage web store.
	 *
	 * NOTE: Since all values are stored as JSON strings, this method will parse the fetched
	 * JSON string and return the resulting object/value.
	 *
	...
	/**
	 * Remove the specified key/value pair from the angular-webstorage store.
	 *
	 * @param {string} key The name of the value to remove.
	 * @return {boolean} True on success, else false.
	 * @private
	...
	/**
	 * Clear all key/value pairs form the angular-webstorage store.
	 *
	 * NOTE: If a prefix has been specified in the module constant 'prefix' then only
	 * values with that specific prefix will be removed.
	 *
	...
	/**
	 * Test the client's support for storing values in the angular-webstorage store.
	 *
	 * @return {boolean} True if the client has support for the angular-webstorage store, else false.
	 * @private
	 */
